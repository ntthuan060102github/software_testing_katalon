...
WebUI.setText(findTestObject('Page_Create new withdrawal  Transactions  Firefly III/input_Source account_source'), 'test')

WebUI.verifyElementPresent(findTestObject('Page_Create new withdrawal  Transactions  Firefly III/input_Source account_source'), 
    0)
