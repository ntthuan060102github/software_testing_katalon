...
WebUI.setText(findTestObject('create_new_asset_account/input_balance_opening_balance'), opening_balance)

WebUI.setText(findTestObject('create_new_asset_account/input_date_picker'), opening_balance_date)
