...
WebUI.setText(findTestObject('create_new_expense_account/input_name'), 'test')

actual_text = WebUI.getAttribute(findTestObject('create_new_expense_account/input_name'), 'value')
